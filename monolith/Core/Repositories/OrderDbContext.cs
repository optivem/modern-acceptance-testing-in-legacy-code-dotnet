...
public class OrderDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.OrderTimestamp).HasColumnName("order_timestamp");
            entity.Property(e => e.Country).HasColumnName("country");
            entity.Property(e => e.Sku).HasColumnName("sku");
            entity.Property(e => e.Quantity).HasColumnName("quantity");
            entity.Property(e => e.UnitPrice).HasColumnName("unit_price").HasPrecision(10, 2);
            entity.Property(e => e.OriginalPrice).HasColumnName("original_price").HasPrecision(10, 2);
            entity.Property(e => e.DiscountRate).HasColumnName("discount_rate").HasPrecision(5, 4);
            entity.Property(e => e.DiscountAmount).HasColumnName("discount_amount").HasPrecision(10, 2);
            entity.Property(e => e.SubtotalPrice).HasColumnName("subtotal_price").HasPrecision(10, 2);
